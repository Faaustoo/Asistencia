document.addEventListener('DOMContentLoaded', function () {
    ...
    formulario.addEventListener('submit', function (e) {
        ...
        fetch('App/alumnos/registroAlumno.php', { 
            method: 'POST', 
            body: datos 
        })
        .then(res => res.json()) 
        .then(data => {
            ...
            if (data.estado === 'exito') {
                ...
                setTimeout(() => {formularioAlumnoDiv.style.display = 'none'; 
                                listaAlumnosDiv.style.display = 'block'; }, 1000);
                cargarAlumnos();
...
function editarAlumno(alumnoId, listaAlumnos) {
    ...
    botonEnviarEditar.addEventListener('click', (event) => {
        ...
        fetch('App/alumnos/editarAlumno.php', {
            method: 'POST',
            body: datos
        })
        .then(res => res.json())
        .then(data => {
            ...
            if (data.estado === 'exito') {
                ...
                setTimeout(() => { document.getElementById('error-editar').innerHTML ='';}, 1500);
            }
        })
        .catch(error => {
...
function eliminarAlumno(alumnoId) {
        ...
        document.getElementById('si').addEventListener('click', (event) => {
            ...
            fetch('App/alumnos/eliminarAlumno.php', {
                method: 'POST',
                body: datos
            })
            .then(res => res.json())
