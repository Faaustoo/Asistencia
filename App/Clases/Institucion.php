<?php
require_once __DIR__ . '/../Traits/ValidarInstitucion.php';
...
class Institucion {
    ...
    public function editarInstitucion($conn, $id_institucion) {
    ...
    public static function existeInstitucion($conn, $nombre, $id_profesor) {
        $sql = "SELECT COUNT(*) FROM " . self::$table . " WHERE nombre = :nombre AND id_profesor = :id_profesor";
